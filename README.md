...
| `/lib/sanity/sanity.api.ts`,`/lib/sanity/sanity.image.ts` | Configuration for the Sanity Content Lake client        |
| `/lib/sanity/sanity.preview.ts`                           | Configuration for the live Preview Mode                 |
